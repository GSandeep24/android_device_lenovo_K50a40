...
$(call inherit-product, device/lenovo/K50a40/vendor/copyfiles.mk)
$(call inherit-product, vendor/lenovo/K50a40/K50a40-vendor-blobs.mk)

LOCAL_PATH := device/lenovo/K50a40
...
TARGET_OTA_ASSERT_DEVICE := K50a40
